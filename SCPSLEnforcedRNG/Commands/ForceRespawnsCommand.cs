...
namespace SCPSLEnforcedRNG
{
    [CommandInformation(
        ...
        Permission = "SCPSLEnforcedRNG.ForceRespawns", // The permission which the player needs to execute the Command
    ...
    public class ForceRespawnsCommand : ISynapseCommand
    {
        ...
        public CommandResult Execute(CommandContext context)
        {
            ...
            Timing.CallDelayed(isChaos ? 10f : 14f, () => Round.Get.MtfRespawn(isChaos));
